...
export default function Finder() {
  ...
  const matches = useMemo(() => {
    let list = tools.filter(t => !useCase || t.categories.some(c => c.toLowerCase().includes(useCase.toLowerCase())));
    if (budget !== "Any") list = list.filter(t => t.pricingType.toLowerCase().includes(budget.toLowerCase()));
    if (skill === "Beginner") list = list.filter(t => !t.categories.some(c => c.toLowerCase().includes("developer") || c.toLowerCase().includes("coding")));
    if (skill === "Advanced") list = list.filter(t => t.categories.some(c => c.toLowerCase().includes("developer") || c.toLowerCase().includes("coding") || c.toLowerCase().includes("research")));
